...
export function FlowButton({ text = "Modern Button" }) {
  return (
    <button className="group relative flex items-center justify-center min-w-[200px] gap-1 overflow-hidden rounded-[100px] border-[1.5px] border-[#333333]/40 dark:border-white/40 bg-transparent px-8 py-3 text-sm font-semibold text-[#111111] dark:text-white cursor-pointer transition-all duration-[600ms] ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-transparent hover:text-white dark:hover:text-black hover:rounded-[12px] active:scale-[0.95]">
      ...
      {/* Circle */}
      <span className="absolute z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-[#111111] dark:bg-white rounded-[50%] opacity-0 group-hover:w-[300px] group-hover:h-[300px] group-hover:opacity-100 transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)]"></span>
